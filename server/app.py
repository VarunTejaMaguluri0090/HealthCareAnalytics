...
def predict():
    ...
    if results == 2:
        if int(data['age']) > 45 and data['chestPainType'] == '1' or data['chestPainType'] == '2' or  int(data['bloodPressure']) > 140 or int(data['cholesterol']) > 220 or int(data['bloodSugar']) >  135 or int(data['maxHeartRate']) > 120 or int(data['maxHeartRate']) < 60 :
